...
public class PanelEliminar extends javax.swing.JPanel {
   ...
   BaseDatos basedatos;
    public PanelEliminar(BaseDatos basedatosx) {
    ...
    private void agregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregarActionPerformed
        ...
        if (documentoe.equals("") || nombrese.equals("") || apellidose.equals("") || telefonoe.equals("") || correoe.equals("")){
            ...
            boolean respuesta = basedatos.EliminarPersona(documentoe);
            System.out.println(respuesta);

            String respuestaRegistro = "";
            if(respuesta = true){
                etqAlerta.setText("El usuario ha sido Eliminado correctamente");
                ...
                etqAlerta.setText( "El usuario no pudo Eliminarse");
