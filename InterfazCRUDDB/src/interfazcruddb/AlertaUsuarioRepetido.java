...
public class AlertaUsuarioRepetido extends javax.swing.JFrame {
    ...
    public AlertaUsuarioRepetido(String Documento, String Correo) {
        
        String Documentor = Documento;
        String Correor = Correo;
        
        initComponents();
        initAlternComponents(Documentor, Correor);        
    }

    public void initAlternComponents(String Documento, String Correo){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("El usuario con los siguientes datos ya se ncuentra registrado:");
        ...
        CampoCorreo.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        CampoCorreo.setForeground(new java.awt.Color(255, 255, 255));
        CampoCorreo.setText("jLabel4");

        CampoDocumento.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        CampoDocumento.setForeground(new java.awt.Color(255, 255, 255));
        CampoDocumento.setText("jLabel4");
